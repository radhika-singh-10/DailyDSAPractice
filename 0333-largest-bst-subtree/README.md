<h2><a href="https://leetcode.com/problems/largest-bst-subtree/?envType=problem-list-v2&envId=depth-first-search">333. Largest BST Subtree</a></h2><h3>Medium</h3><hr><p>Given the root of a binary tree, find the largest <span data-keyword="subtree">subtree</span>, which is also a Binary Search Tree (BST), where the largest means subtree has the largest number of nodes.</p>
